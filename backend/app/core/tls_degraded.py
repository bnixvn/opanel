...
RECOVERY_COMMAND = (
    "sudo -u opanel env HOME=/opt/opanel sudo -n "
    "/usr/local/sbin/opanel-helper panel-cert-sync"
)

_PAGE = f"""<!doctype html>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>OPanel unavailable</title>
<style>
...
<main>
  ...
  <ol>
    <li>
      ...
      <pre>journalctl -u opanel-api -n 50 --no-pager</pre>
    </li>
    <li>
    ...
    <li>
      ...
      <pre>systemctl restart opanel-api</pre>
    </li>
  </ol>
</main>
"""
